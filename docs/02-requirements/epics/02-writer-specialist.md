...
- [ ] **Format compliance: word budget not enforced** — Chain test (2026-03-04, ai-ecosystem-roles-workforce) produced ~1,500 words with `output_format: brief`. Epic 02 success criteria state "Output format matches the requested format on every invocation (brief is a brief, not a report)" — this is specified but not working. Writer Stage 3 (Structure) needs explicit word budget enforcement: brief ~600 words, report ~1,500, executive summary ~400. *(from test log 2026-03-04)*
- [ ] **Dedup pass missing before final output** — Chain test (2026-03-04, ai-ecosystem-roles-workforce) found the "Three Asymmetries" section substantially repeated content already present in "Key Points." A dedup pass in Stage 4 (Draft) or Stage 5 (Verify) would catch repeated content across sections before the document is returned. *(from test log 2026-03-04)*
