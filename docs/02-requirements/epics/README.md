...
See [docs/templates/EPIC_TEMPLATE.md](../../templates/EPIC_TEMPLATE.md) for the template.

**User stories for implemented features:** create individual files in `docs/02-requirements/user-stories/[epic-number]-[epic-name]/` following `USER_STORY_TEMPLATE.md`. Future work stays in the epic's Future section until ready to build.

---

## Epic Index

| # | Epic | Status | Specialists |
|---|------|--------|-------------|
